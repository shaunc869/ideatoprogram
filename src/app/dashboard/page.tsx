    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-gray-400">
          {user.isPro ? (
            <span className="inline-flex items-center gap-2">
              ...
              You have access to all 210 lessons
            </span>
          ) : (
            <span>You have access to 10 free lessons. <Link href="/upgrade" className="text-indigo-400 hover:underline">Upgrade to Pro</Link> for all 210.</span>
          )}
        </p>
      </div>
      ...
      {!user.isPro && (
        <div className="bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-500 rounded-xl p-6 text-center">
          <h3 className="text-xl font-bold mb-2">Unlock All 210 Lessons</h3>
